                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg-end">
                            <li><a class="dropdown-item" href="../../templates/lecturer/profile.php">โปรไฟล์</a></li>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td style='width: 45%;'><a href='file_lect.php?folder_id=" . $row['folder_id'] . "'>" . $row['folder_name'] . "</a></td>";
                            ...
                            echo "<td style='width: 5%;'><a class='link-dark' href='#' data-bs-toggle='dropdown' aria-expanded='false'><i class='fas fa-ellipsis-h '></i></a>
                                    <ul class='dropdown-menu'>
                                        <li><a id='exit' class='dropdown-item' href='folder_del.php?folder_id=" . $row['folder_id'] . "'>ลบ</a></li>
                                    </ul></td>";
                            echo "</tr>";
                        }
                    }
