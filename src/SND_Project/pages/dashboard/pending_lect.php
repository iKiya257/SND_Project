        ...
        $(document).ready(function() {
            $('#listSendTable').DataTable({
                ...
                "language": {
                    ...
                    "emptyTable": "ไม่มีเอกสารรอดำเนินการ"
                }
            });
        });
    </script>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            if (!empty($row['name'])) {
                                echo "<a href='../inbox/viewinbox_lect.php?submission_id=" . $row['submission_id'] . "'>" . $row['name'] . "</a>";
                            } else {
                                echo "<a href='../inbox/viewinbox_lect.php?submission_id=" . $row['submission_id'] . "'>ไม่มีชื่อเรื่อง</a>";
                            }
                            if ($row['urgency'] == 1) {
                            ...
                            echo "<td style='width: 10%;' class='text-center'><h5 class='text-center'><span class='badge rounded-pill text-bg-success'>รอดำเนินการ</span></h5></td>";
                            echo "</tr>";
                        }
                    }
                    ?>
