        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#"><img src="../../assets/img/notification.png" width="20px"></a>
                    </li>
        ...
        <div class="sidebar-dash">
            <div class="list-dash">
                <div class="dash">
                    ...
                    <ul>
                        <li><a href="../../pages/manage/user.php">
                                <div><i class="fa-solid fa-user-gear"></i> การจัดการผู้ใช้</div>
                            </a></li>
                        <li><a href="../../pages/manage/department.php">
                    ...
                    <ul>
                        <li><a href="../../pages/manage/doc.php">
                                <div><i class="fa-solid fa-gear"></i> การจัดการเอกสาร</div>
                            </a></li>
                        <li><a href="../../pages/manage/purpose.php">
